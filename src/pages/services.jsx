...
function ServicesPage() {
  ...
  return (
    <>
      <SeoHead
        title="Servicios Publicitarios | Elephant Group - Diseño, Impresión y Señalética en Valparaíso"
        description="Servicios de diseño gráfico, impresión digital, señalética y material POP en Valparaíso y Viña del Mar. Soluciones creativas y personalizadas para empresas."
        keywords="servicios publicitarios, diseño gráfico, impresión digital, señalética, material POP, Elephant Group, Valparaíso, Viña del Mar, soluciones publicitarias, empresas"
        author="Elephant Group"
        canonical="https://landingclientes.elephantgroup.cl/servicios"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "Service",
          serviceType: "Servicios Publicitarios, Diseño Gráfico e Impresión",
          provider: {
            "@type": "Organization",
            name: "Elephant Group",
